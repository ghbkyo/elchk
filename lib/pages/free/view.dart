...
class FreePage extends GetView<FreeController> {
...
// status 1 狀態更新 2 活動更新 3  會籍到期提示
  ...
  Widget shipStep() {
    ...
    return Row(
      ...
      children: [
        tex('填寫資料',
            fontSize: controller.state.shipStep == 0 ? 20 : 16,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          itemButton('下一步').onTap(() => controller.changeStepIndex(2)),
        ],
      ),
    );
  }

  Widget shipPaymentItem(String txt, String svg) {
    String icon = 'check';
    bool checked = svg == controller.state.payMode;
    if (checked) {
      icon = 'checked';
    }
    ...
    return Row(
      ...
      children: [
        ...
        if (checked) const Icon(Icons.arrow_right),
      ],
    )
        .container(
        ...
        .onTap(() => controller.changePayMode(svg));
  }
    ...
    return SizedBox(
      ...
      child: Column(
        ...
        children: [
          ...
          //if (controller.state.shipStep == 1) shipBodyContent03(),
  ...
  Widget confirmDialog() {
    String name = controller.state.post['name'];
    int programEnrollmentId = controller.state.joinRes['programEnrollmentId'];
    return Column(
      children: [
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<FreeController>(
      init: FreeController(),
      id: 'free',
      builder: (controller) {
        return Scaffold(
