        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              hr,
              remarkItem('日期：${controller.state.post['date']}', 'date'),
              hr,
              remarkItem('時間：${controller.state.post['time']}', 'time'),
              hr,
              remarkItem('地點：${controller.state.post['address']}', 'address'),
              hr,
              remarkItem('名額：${controller.state.post['memberNums']}人', 'user'),
              hr,
              remarkItem('價錢：${controller.state.post['isFree'] ? '免费' : '收费'}',
                  'money'),
              hr,
              tex(
                '活動內容',
